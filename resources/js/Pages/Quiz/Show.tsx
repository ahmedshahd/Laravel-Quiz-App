...
const Show: React.FC<ShowProps> = ({prevScore,auth, csrf, quiz}) => {
    ...
    return (
        <Layout csrf={csrf} isLoggedIn={auth.user !== null}>
            <div className="container mx-auto p-4 mt-4 space-y-4">
                ...
                {(prevScore && submitted) ? <PreviouslyTookQuiz prevScore={prevScore} otherScores={[]}/> : <div><TakeQuiz questions={quiz.questions}
